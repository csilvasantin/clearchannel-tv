...
const I18N = {
  es: {
    ...
    demo_circuit:'Tour DooH', demo_stop:'Parar Tour DooH',
    demo_ready:'Tour DooH listo: recorre <b>{points}</b> puntos del circuito completo.',
    demo_empty:'No hay puntos en este circuito para Tour DooH.',
    demo_progress:'Tour DooH {current}/{total} · {name}',
    demo_done:'Tour DooH completado · {points} puntos',
  ...
  en: {
    ...
    demo_circuit:'Tour DooH', demo_stop:'Stop Tour DooH',
    demo_ready:'Tour DooH ready: touring <b>{points}</b> points across the full circuit.',
    demo_empty:'There are no points in this circuit for Tour DooH.',
    demo_progress:'Tour DooH {current}/{total} · {name}',
    demo_done:'Tour DooH completed · {points} points',
